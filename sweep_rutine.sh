...
#	python3 growNet.py --size 500 --S_0 1 --S_1 4 --ratio 0.34 --replacement 0.2 >/dev/null
	...
	./ising_model --J_ij="{0.2, 2.7, -1.5}" --D_i="{-0.5, 0}" --T=5.5 --xrate=0 --init=sat --out=output --seed=$1 > output.txt
	echo "$2 $(python3 average.py -s --trim --T 5.5 --size 50)" >> ../susceptibility.txt
